...
cat = subprocess.Popen(["/home/marco/Documenti/hadoop/bin/hdfs", "dfs", "-cat", "input/historical_stocks.csv"], stdout=subprocess.PIPE)
...
for line in sys.stdin:
    ...
    dict_key = '{0}-{1}'.format(dict_stocks.get(ticker, 'GNE'), date.split('-')[0])
