DATA = {
    'local': {
        ...
        'hive': {
            'job1': (115, 130, 145, 175, 195, 215, 245, 0, 0, 0),  # TODO last three
            'job2': (195, 220, 245, 285, 320, 355, 390, 0, 0, 0),  # TODO last three
            'job3': (240, 250, 275, 300, 332, 355, 375, 0, 0, 0)  # TODO last three
        }
    },
    'remote': {
        'map_reduce': {
        ...
        'spark': {
            'job1': (43, 59, 77, 99, 138, 158, 163, 0, 0, 0),  # TODO last three
            'job2': (47, 62, 81, 95, 129, 146, 166, 0, 0, 0),  # TODO last three
            'job3': (44, 60, 72, 88, 125, 140, 143, 0, 0, 0)  # TODO last three
        },
        'hive': {
